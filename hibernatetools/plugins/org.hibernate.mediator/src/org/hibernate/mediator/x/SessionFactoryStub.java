...
import org.hibernate.mediator.x.engine.query.HQLQueryPlanStub;
...
public class SessionFactoryStub extends HObject {
	...
	public SessionFactoryStub(Object sessionFactory) {
	...
	@SuppressWarnings("unchecked")
	public Map<String, ClassMetadataStub> getAllClassMetadata() {
		if (Obj() == null) {
	...
	@SuppressWarnings("unchecked")
	public Map<String, CollectionMetadataStub> getAllCollectionMetadata() {
		if (Obj() == null) {
