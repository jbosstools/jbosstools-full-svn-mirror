...
import org.hibernate.mediator.x.proxy.HibernateProxyHelper;
...
public class Session extends HObject {
	...
	public SessionFactory getSessionFactory() {
		return new SessionFactory(invoke(mn()));
	}
	...
	public List<Object> evalCriteria(String criteriaCode, QueryInputModel model, Time queryTime,
		...
		try {
			...
			if (Criteria.CL.equals(o.getClass().getName())) {
				Criteria criteria = new Criteria(o);
				if (maxResults != null) {
	...
	public Query createQuery(String queryString) {
		return new Query(invoke(mn(), queryString));
	}
