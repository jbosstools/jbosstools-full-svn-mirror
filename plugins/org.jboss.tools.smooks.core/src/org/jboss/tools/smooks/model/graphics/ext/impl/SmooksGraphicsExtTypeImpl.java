 ...
 * <em><b>Smooks Graphics Ext Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.jboss.tools.smooks.model.graphics.ext.impl.SmooksGraphicsExtTypeImpl#getInput
 * <em>Input</em>}</li>
 * <li>
 * {@link org.jboss.tools.smooks.model.graphics.ext.impl.SmooksGraphicsExtTypeImpl#getGraph
 * <em>Graph</em>}</li>
 * <li>
 * {@link org.jboss.tools.smooks.model.graphics.ext.impl.SmooksGraphicsExtTypeImpl#getAuthor
 * <em>Author</em>}</li>
 * <li>
 * {@link org.jboss.tools.smooks.model.graphics.ext.impl.SmooksGraphicsExtTypeImpl#getInputType
 * <em>Input Type</em>}</li>
 * <li>
 * {@link org.jboss.tools.smooks.model.graphics.ext.impl.SmooksGraphicsExtTypeImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link org.jboss.tools.smooks.model.graphics.ext.impl.SmooksGraphicsExtTypeImpl#getOutputType
 * <em>Output Type</em>}</li>
 * <li>
 * {@link org.jboss.tools.smooks.model.graphics.ext.impl.SmooksGraphicsExtTypeImpl#getPlatformVersion
 * <em>Platform Version</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class SmooksGraphicsExtTypeImpl extends AbstractResourceConfigImpl implements SmooksGraphicsExtType {
	...
	/**
	 * The default value of the '{@link #getInputType() <em>Input Type</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getInputType()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getInputType() <em>Input Type</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getInputType()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getPlatformVersion()
	 * <em>Platform Version</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getPlatformVersion()
	 * <em>Platform Version</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getPlatformVersion()
	...
	public EList<InputType> getInput() {
		if (input == null) {
			input = new EObjectContainmentEList<InputType>(InputType.class, this,
					GraphPackage.SMOOKS_GRAPHICS_EXT_TYPE__INPUT);
		}
		return input;
	}
	...
	public NotificationChain basicSetGraph(GraphType newGraph, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GraphPackage.SMOOKS_GRAPHICS_EXT_TYPE__GRAPH, oldGraph, newGraph);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newGraph != graph) {
			...
			if (graph != null)
				msgs = ((InternalEObject) graph).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- GraphPackage.SMOOKS_GRAPHICS_EXT_TYPE__GRAPH, null, msgs);
			if (newGraph != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.SMOOKS_GRAPHICS_EXT_TYPE__GRAPH,
					newGraph, newGraph));
	}
	...
	public void setAuthor(String newAuthor) {
		...
		author = newAuthor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.SMOOKS_GRAPHICS_EXT_TYPE__AUTHOR,
					oldAuthor, author));
	}
	...
	public void setInputType(String newInputType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.SMOOKS_GRAPHICS_EXT_TYPE__INPUT_TYPE,
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.SMOOKS_GRAPHICS_EXT_TYPE__NAME, oldName,
					name));
	}
	...
	public void setOutputType(String newOutputType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.SMOOKS_GRAPHICS_EXT_TYPE__OUTPUT_TYPE,
	...
	public void setPlatformVersion(String newPlatformVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GraphPackage.SMOOKS_GRAPHICS_EXT_TYPE__PLATFORM_VERSION, oldPlatformVersion, platformVersion));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case GraphPackage.SMOOKS_GRAPHICS_EXT_TYPE__PLATFORM_VERSION:
			return PLATFORM_VERSION_EDEFAULT == null ? platformVersion != null : !PLATFORM_VERSION_EDEFAULT
