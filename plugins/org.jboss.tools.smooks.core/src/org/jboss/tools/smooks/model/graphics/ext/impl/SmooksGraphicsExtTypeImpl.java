...
public class SmooksGraphicsExtTypeImpl extends EObjectImpl implements SmooksGraphicsExtType {
	...
	public void setAuthor(String newAuthor) {
		...
		for (Iterator<ISmooksGraphChangeListener> iterator = listeners.iterator(); iterator.hasNext();) {
			...
			iSmooksGraphChangeListener.graphPropertyChange(GraphPackage.Literals.SMOOKS_GRAPHICS_EXT_TYPE__AUTHOR, author);
		}
	}
	...
	public void setName(String newName) {
		...
		for (Iterator<ISmooksGraphChangeListener> iterator = listeners.iterator(); iterator.hasNext();) {
			ISmooksGraphChangeListener iSmooksGraphChangeListener = (ISmooksGraphChangeListener) iterator.next();
			iSmooksGraphChangeListener.graphPropertyChange(GraphPackage.Literals.SMOOKS_GRAPHICS_EXT_TYPE__NAME, name);
		}
	}
	...
	public void setPlatformVersion(String newPlatformVersion) {
		...
		for (Iterator<ISmooksGraphChangeListener> iterator = listeners.iterator(); iterator.hasNext();) {
			ISmooksGraphChangeListener iSmooksGraphChangeListener = (ISmooksGraphChangeListener) iterator.next();
			iSmooksGraphChangeListener.graphPropertyChange(GraphPackage.Literals.SMOOKS_GRAPHICS_EXT_TYPE__PLATFORM_VERSION, platformVersion);
		}
	}
