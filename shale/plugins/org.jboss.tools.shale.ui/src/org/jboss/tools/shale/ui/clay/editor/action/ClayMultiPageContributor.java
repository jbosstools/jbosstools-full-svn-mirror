...
import org.jboss.tools.shale.ui.clay.editor.ClayGuiEditor;

public class ClayMultiPageContributor extends AbstractMultiPageContributor {
	ActionRegistrySupport registrySupport = new ClayRegistrySupport();

	public ClayMultiPageContributor() {}
	...
	public void init(IActionBars bars) {
		...
		registrySupport.addRetargetAction(new ClayCutRetargetAction());
	...
	public void setActivePage(IEditorPart part) {
		...
		if (actionBars != null) {
			...
			if(fActiveEditorPart instanceof ClayGuiEditor)
...
//				registerKeyBindings(handler, ACTIONS_1, fakeTextEditor);
	...
	class ClayRegistrySupport extends ActionRegistrySupport{
...
///			addRetargetAction(new JSFCutRetargetAction());
