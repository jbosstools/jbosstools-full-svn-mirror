...
public class AdviceWizardPage extends WizardPage {
	...
	public AdviceWizardPage (ArrayList pointcuts) 
		throws Exception
	{
		super("Advice Wizard", "Apply Advice...", ImageDescriptor.createFromURL(new URL("file:///C:/Code/jboss-aop-eclipse/org.jboss.ide.eclipse.jdt.aop.ui/icons/aspect.gif")));
