...
public class nsIDocShell extends nsISupports {
	...
	public nsIClipboardDragDropHookList getClipboardDragDropHookList() {
		int aClipboardDragDropHookList = getInterface(nsIClipboardDragDropHookList.NS_ICLIPBOARDDRAGDROPHOOKLIST_IID);
		return new nsIClipboardDragDropHookList(aClipboardDragDropHookList);
	}
}