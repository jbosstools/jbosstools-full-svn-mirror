...
public class XulRunnerConstants {
	...
	public static final String HTML_ATTR_ANONLOCATION = "anonlocation"; //$NON-NLS-1$
	...
	public static final String STRING_MOZ_ACTIVATED = "_moz_activated"; //$NON-NLS-1$

	/** STRING_MOZ_ANONCLASS */
	public static final String STRING_MOZ_ANONCLASS = "_moz_anonclass"; //$NON-NLS-1$
	
	/** VPE_CLASSNAME_MOZ_RESIZER */
	public static final String VPE_CLASSNAME_MOZ_RESIZER = "mozResizer"; //$NON-NLS-1$
