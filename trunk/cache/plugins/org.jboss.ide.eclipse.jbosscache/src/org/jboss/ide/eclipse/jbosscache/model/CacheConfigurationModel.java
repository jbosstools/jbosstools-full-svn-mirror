...
public class CacheConfigurationModel
{
   ...
   /**
    * Contains the cluster configuration related params
    * @author Gurkaner
    *
    */
   ...
   {
      //First part
      private String mcast_addrForUdp;

      private String mcast_portForUdp;

      private String ip_ttlForUdp;

      private boolean ip_mcastForUdp;

      private String mcast_send_buf_sizeForUdp;

      private String mcast_recv_buf_sizeForUdp;

      private String ucast_recv_buf_sizeForUdp;

      private String ucast_send_buf_sizeForUdp;

      private String timeoutForPing;

      private boolean loopbackForUdp;

      private String num_initial_membersForPing;

      private boolean up_threadForPing;

      private boolean down_threadForPing;

      private String min_intervalForMerge2;

      private String max_intervalForMerge2;

      private boolean shunForFd;

      private boolean up_threadForFd;

      private boolean down_threadForFd;

      //Second part
      private String sectimeoutForVerifySuspect;

      private boolean secup_threadForVerifySuspect;

      private boolean secdown_threadForVerifySuspect;

      private String secgc_lagForPbCastNakAck;

      private String secretransmit_timeoutForPbCastNakAck;

      private String secmax_xmit_sizeForPbCastNakAck;

      private boolean secup_threadForPbCastNakAck;

      private boolean secdown_threadForPbCastNakAck;

      private String sectimeoutForUniCast;

      private String secwindow_sizeForUniCast;

      private String secmin_thresholdForUniCast;

      private boolean secdown_threadForUniCast;

      private String secdesired_avg_gossipForPbCastStable;

      private boolean secdown_threadForPbCastStable;

      private boolean secup_threadForPbCastStable;

      //Third Part
      private String thirdfrag_sizeForFrag;

      private boolean thirddown_threadForFrag;

      private boolean thirdup_threadForFrag;

      private String thirdjoin_timeoutForPbCastGms;

      private String thirdjoin_retry_timeoutForPbCastGms;

      private boolean thirdshunForPbCastGms;

      private boolean thirdprint_local_addrForPbCastGms;

      private boolean thirddown_threadForPbCastStateTransfer;

      private boolean thirdup_threadForPbCastStateTransfer;
