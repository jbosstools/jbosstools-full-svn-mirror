 ...
 * @generated
 */
public class ExclusiveGateway2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ExclusiveGateway2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ExclusiveGateway2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ExclusiveGatewayFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public ExclusiveGatewayFigureDescriptor getPrimaryShape() {
		return (ExclusiveGatewayFigureDescriptor) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.ExclusiveGateway2EditPart) {
			types.add(Bpmn2ElementTypes.SequenceFlow_4001);
		}
