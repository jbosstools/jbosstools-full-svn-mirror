...
{
   /**Constructor for the NewEntityEJBWizard object */
   public NewEntityEJBWizard()
   {
      this.setWindowTitle(JDTJ2EEUIMessages.getString("NewEntityEJBWizard.window.title"));//$NON-NLS-1$
   }
   ...
   {
      return new NewEntityEJBWizardPage(root);
   }
}
