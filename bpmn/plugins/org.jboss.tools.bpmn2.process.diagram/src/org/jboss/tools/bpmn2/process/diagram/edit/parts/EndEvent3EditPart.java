 ...
 * @generated
 */
public class EndEvent3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EndEvent3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EndEvent3ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new TerminateEndEventFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public TerminateEndEventFigureDescriptor getPrimaryShape() {
		return (TerminateEndEventFigureDescriptor) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.EndEvent3EditPart) {
			types.add(Bpmn2ElementTypes.SequenceFlow_4001);
		}
