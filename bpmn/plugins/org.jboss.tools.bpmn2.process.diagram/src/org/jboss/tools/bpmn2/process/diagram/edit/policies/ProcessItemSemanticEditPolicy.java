...
import org.jboss.tools.bpmn2.process.diagram.edit.commands.BusinessRuleTaskCreateCommand;
...
public class ProcessItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (Bpmn2ElementTypes.BusinessRuleTask_2018 == req.getElementType()) {
			return getGEFWrapper(new BusinessRuleTaskCreateCommand(req));
		}
