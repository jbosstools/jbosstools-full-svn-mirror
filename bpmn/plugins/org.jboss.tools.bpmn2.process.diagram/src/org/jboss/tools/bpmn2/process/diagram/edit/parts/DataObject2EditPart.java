...
import org.jboss.tools.bpmn2.process.diagram.edit.policies.DataObject2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DataObject2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		org.eclipse.gmf.runtime.diagram.ui.editpolicies.LayoutEditPolicy lep = new org.eclipse.gmf.runtime.diagram.ui.editpolicies.LayoutEditPolicy() {
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				...
				switch (Bpmn2VisualIDRegistry.getVisualID(childView)) {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new DataObjectFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public DataObjectFigureDescriptor getPrimaryShape() {
		return (DataObjectFigureDescriptor) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof DataObjectName2EditPart) {
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(21, 26);
		return result;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.DataObject2EditPart) {
			types.add(Bpmn2ElementTypes.Association_4002);
		}
	 ...
	 * @generated
	 */
	public class DataObjectFigureDescriptor extends RectangleFigure {
		...
		private void createContents() {
			...
			PolygonShape dogEarPage0 = new PolygonShape();
			dogEarPage0.addPoint(new Point(getMapMode().DPtoLP(12),
					getMapMode().DPtoLP(0)));
			dogEarPage0.addPoint(new Point(getMapMode().DPtoLP(20),
					getMapMode().DPtoLP(8)));
			dogEarPage0.addPoint(new Point(getMapMode().DPtoLP(20),
					getMapMode().DPtoLP(25)));
			dogEarPage0.addPoint(new Point(getMapMode().DPtoLP(0), getMapMode()
					.DPtoLP(25)));
			dogEarPage0.addPoint(new Point(getMapMode().DPtoLP(0), getMapMode()
					.DPtoLP(0)));
			dogEarPage0.addPoint(new Point(getMapMode().DPtoLP(12),
