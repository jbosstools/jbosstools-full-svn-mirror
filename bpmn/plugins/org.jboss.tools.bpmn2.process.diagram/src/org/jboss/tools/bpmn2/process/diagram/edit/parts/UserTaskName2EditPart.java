 ...
 * @generated
 */
public class UserTaskName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UserTaskName2EditPart(View view) {
		super(view);
	}
			...
			parser = Bpmn2ParserProvider
					.getParser(
							...
							Bpmn2VisualIDRegistry
									.getType(org.jboss.tools.bpmn2.process.diagram.edit.parts.UserTaskName2EditPart.VISUAL_ID));
		}
		return parser;
	}
