 ...
 * @generated
 */
public class EndEvent6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EndEvent6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EndEvent6ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.EndEvent6EditPart) {
			types.add(Bpmn2ElementTypes.SequenceFlow_4001);
		}
