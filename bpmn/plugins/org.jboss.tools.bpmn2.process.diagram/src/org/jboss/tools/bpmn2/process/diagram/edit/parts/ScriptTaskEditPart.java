...
import org.jboss.tools.bpmn2.process.diagram.edit.policies.ScriptTaskItemSemanticEditPolicy;
...
public class ScriptTaskEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.ScriptTaskEditPart) {
			types.add(Bpmn2ElementTypes.SequenceFlow_4001);
		}
