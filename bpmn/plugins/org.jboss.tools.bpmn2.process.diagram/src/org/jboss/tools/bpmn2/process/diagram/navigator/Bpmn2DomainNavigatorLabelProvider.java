 ...
 * @generated
 */
public class Bpmn2DomainNavigatorLabelProvider implements ICommonLabelProvider {
	...
	public Image getImage(Object element) {
		if (element instanceof Bpmn2DomainNavigatorItem) {
			return myAdapterFactoryLabelProvider
					.getImage(((Bpmn2DomainNavigatorItem) element).getEObject());
		}
		return null;
	}
	...
	public String getText(Object element) {
		if (element instanceof Bpmn2DomainNavigatorItem) {
			return myAdapterFactoryLabelProvider
					.getText(((Bpmn2DomainNavigatorItem) element).getEObject());
		}
		return null;
	}
