 ...
 * @generated
 */
public class TextAnnotationText2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = Bpmn2ParserProvider
					.getParser(
							...
							Bpmn2VisualIDRegistry
									.getType(org.jboss.tools.bpmn2.process.diagram.edit.parts.TextAnnotationText2EditPart.VISUAL_ID));
		}
		return parser;
	}
