...
import org.jboss.tools.bpmn2.process.diagram.edit.policies.UserTask2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UserTask2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UserTask2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UserTask2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UserTaskName2EditPart) {
			((UserTaskName2EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureName());
			return true;
		}
		return false;
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(Bpmn2VisualIDRegistry
				.getType(UserTaskName2EditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.UserTask2EditPart) {
			types.add(Bpmn2ElementTypes.SequenceFlow_4001);
		}
