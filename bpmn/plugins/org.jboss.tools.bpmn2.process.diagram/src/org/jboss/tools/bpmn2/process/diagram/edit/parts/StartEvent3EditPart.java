 ...
 * @generated
 */
public class StartEvent3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public StartEvent3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StartEvent3ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new StartEventFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public StartEventFigureDescriptor getPrimaryShape() {
		return (StartEventFigureDescriptor) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.StartEvent3EditPart) {
			types.add(Bpmn2ElementTypes.SequenceFlow_4001);
		}
