...
import org.jboss.tools.bpmn2.process.diagram.edit.policies.BusinessRuleTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BusinessRuleTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public BusinessRuleTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BusinessRuleTaskItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BusinessRuleTaskNameEditPart) {
			((BusinessRuleTaskNameEditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.BusinessRuleTaskEditPart) {
			types.add(Bpmn2ElementTypes.SequenceFlow_4001);
		}
