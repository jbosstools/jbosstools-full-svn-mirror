 ...
 * @generated
 */
public class ServiceTaskName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ServiceTaskName2EditPart(View view) {
		super(view);
	}
			...
			parser = Bpmn2ParserProvider
					.getParser(
							...
							Bpmn2VisualIDRegistry
									.getType(org.jboss.tools.bpmn2.process.diagram.edit.parts.ServiceTaskName2EditPart.VISUAL_ID));
		}
		return parser;
	}
