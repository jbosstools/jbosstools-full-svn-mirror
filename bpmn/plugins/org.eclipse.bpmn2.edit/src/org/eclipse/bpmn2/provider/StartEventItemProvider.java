...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn2.StartEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StartEventItemProvider extends CatchEventItemProvider implements
    ...
    public Object getImage(Object object) {
        try {
            return overlayImage(object,
                    getResourceLocator().getImage(getImagePath((StartEvent) object)));
    ...
    private boolean isMessageStartEvent(StartEvent startEvent) {
        List<EventDefinition> eventDefinitions = startEvent.getEventDefinitions();
        List<EventDefinition> eventDefinitionRefs = startEvent.getEventDefinitionRefs();
    ...
    private String getImagePath(StartEvent startEvent) {
        if (isMessageStartEvent(startEvent)) {
            return "added/obj16/events_16px_start_message.png";
        } else {
            return "added/obj16/events_16px_start_none.png";
        }
    }
