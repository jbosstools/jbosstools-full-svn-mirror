 ...
 * @created   17 mai 2003
 */
public class LauncherUIMessages
{
   private final static String BUNDLE_NAME = "org.jboss.ide.eclipse.launcher.ui.LauncherUIMessages";//$NON-NLS-1$

   private final static ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle(BUNDLE_NAME);

   /** Default Constructor */
   private LauncherUIMessages()
   {
   }
