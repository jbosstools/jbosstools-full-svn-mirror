 ...
 * @version   $Revision$
 */
public class NewApplicationXml13PageWizard extends NewFileWizard
{
   /**Constructor for the NewApplicationXml13PageWizard object */
   public NewApplicationXml13PageWizard()
   {
   }
   ...
   {
      return new NewApplicationXml13PageWizardPage(selection);
   }

   /**
    * Gets the wizardTitle attribute of the NewApplicationXml13PageWizard object
    *
    * @return   The wizardTitle value
    */
   protected String getWizardTitle()
   {
      return JDTJ2EEXMLUIMessages.getString("NewApplicationXml13PageWizard.window.title");//$NON-NLS-1$
   }
}
