 ...
 * @generated
 */
public class ExclusiveGatewayCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ExclusiveGatewayCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance()
				.init_ExclusiveGateway_2005(newElement);
