 ...
 * @generated
 */
public class EndEvent5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EndEvent5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EndEvent5ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new MessageEndEventFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public MessageEndEventFigureDescriptor getPrimaryShape() {
		return (MessageEndEventFigureDescriptor) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.EndEvent5EditPart) {
			types.add(Bpmn2ElementTypes.SequenceFlow_4001);
		}
