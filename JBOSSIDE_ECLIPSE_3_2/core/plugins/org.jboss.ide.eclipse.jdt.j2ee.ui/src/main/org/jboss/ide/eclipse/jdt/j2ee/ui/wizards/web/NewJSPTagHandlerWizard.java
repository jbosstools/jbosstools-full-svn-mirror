...
{
   /**Constructor for the NewJSPTagHandlerWizard object */
   public NewJSPTagHandlerWizard()
   {
      this.setWindowTitle(JDTJ2EEUIMessages.getString("NewJSPTagHandlerWizard.window.title"));//$NON-NLS-1$
   }
   ...
   {
      return new NewJSPTagHandlerWizardPage(root);
   }
}
