...
//	{
//		var sel = window.getSelection();
//		if (sel.isCollapsed && (event.keyCode == 46)) {
//			var ip_mem = sel.insertionPoint(true);
//			var ip = ip_mem.clone();
//			sel.moveInsertionPoint(Selection.MOVE_FORWARD_ONE);
//			var eq = ip_mem.equivalent(ip);
//			if (!eq) {
//				return sel.deleteSelection();
//			} else {
//				return false;
//			}
//		} else {
...
//		return window.getSelection().splitXHTMLLine(event.shiftKey);
		return window.getSelection().splitXHTMLLine(true);
	}
*/
