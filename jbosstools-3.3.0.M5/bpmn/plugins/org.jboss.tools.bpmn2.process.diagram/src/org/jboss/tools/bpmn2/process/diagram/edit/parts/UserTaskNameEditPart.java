 ...
 * @generated
 */
public class UserTaskNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = Bpmn2ParserProvider
					.getParser(
							...
							Bpmn2VisualIDRegistry
									.getType(org.jboss.tools.bpmn2.process.diagram.edit.parts.UserTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
