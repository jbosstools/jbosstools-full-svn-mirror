...
public class ServiceTaskCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ServiceTask newElement = Bpmn2Factory.eINSTANCE.createServiceTask();

		FlowElementsContainer owner = (FlowElementsContainer) getElementToEdit();
		owner.getFlowElements().add(newElement);

		ElementInitializers.getInstance().init_ServiceTask_2002(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(ServiceTask newElement,
