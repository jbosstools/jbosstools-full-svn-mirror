...
public class ItemDefinitionImpl extends RootElementImpl implements ItemDefinition {
    ...
    /**
     * This is true if the Structure Ref attribute has been set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    protected boolean structureRefESet;
    ...
    public void setStructureRef(String newStructureRef) {
        ...
        boolean oldStructureRefESet = structureRefESet;
        structureRefESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
    ...
    public void unsetStructureRef() {
        String oldStructureRef = structureRef;
        boolean oldStructureRefESet = structureRefESet;
        structureRef = STRUCTURE_REF_EDEFAULT;
        structureRefESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET,
                    Bpmn2Package.ITEM_DEFINITION__STRUCTURE_REF, oldStructureRef,
                    STRUCTURE_REF_EDEFAULT, oldStructureRefESet));
    }
