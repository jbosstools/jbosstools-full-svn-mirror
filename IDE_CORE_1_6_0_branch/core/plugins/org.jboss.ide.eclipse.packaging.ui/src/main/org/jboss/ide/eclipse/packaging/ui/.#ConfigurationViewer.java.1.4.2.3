...
import org.jboss.ide.eclipse.packaging.ui.util.ConfigurationContentProvider;
import org.jboss.ide.eclipse.packaging.ui.util.ConfigurationLabelProvider;
...
public class ConfigurationViewer implements IPropertyChangeListener
{
   ...
   /**
    * Adds a feature to the DoubleClickListener attribute of the
    * ConfigurationViewer object
    *
    *
   ...
   /**
    * Adds a feature to the SelectionChangedListener attribute of the
    * ConfigurationViewer object
    *
    *
    * @param listener              The feature to be added to the SelectionChangedListener
    *            attribute
    */
   ...
   {
      manager.add(this.addArchiveAction);
      manager.add(this.addFileAction);
      manager.add(this.addFolderAction);
      manager.add(this.editAction);
      manager.add(this.removeAction);
      manager.add(new Separator("Standard"));//$NON-NLS-1$
      manager.add(this.addStandardArchiveAction);
