 ...
 * @generated
 */
public class EndEvent4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EndEvent4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EndEvent4ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EndEventFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public EndEventFigureDescriptor getPrimaryShape() {
		return (EndEventFigureDescriptor) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.EndEvent4EditPart) {
			types.add(Bpmn2ElementTypes.SequenceFlow_4001);
		}
