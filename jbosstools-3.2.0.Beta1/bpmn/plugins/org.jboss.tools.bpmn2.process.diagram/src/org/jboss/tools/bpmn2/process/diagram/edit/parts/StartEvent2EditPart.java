 ...
 * @generated
 */
public class StartEvent2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StartEvent2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new MessageStartEventFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public MessageStartEventFigureDescriptor getPrimaryShape() {
		return (MessageStartEventFigureDescriptor) primaryShape;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.jboss.tools.bpmn2.process.diagram.edit.parts.StartEvent2EditPart) {
			types.add(Bpmn2ElementTypes.SequenceFlow_4001);
		}
