 ...
 * @generated
 */
public class Bpmn2NewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	public Bpmn2NewDiagramFileWizard(URI domainModelURI, EObject diagramRoot,
		...
		myFileCreationPage = new WizardNewFileCreationPage(
				Messages.Bpmn2NewDiagramFileWizard_CreationPageName,
				StructuredSelection.EMPTY);
		myFileCreationPage
				.setTitle(Messages.Bpmn2NewDiagramFileWizard_CreationPageTitle);
		myFileCreationPage.setDescription(NLS.bind(
				Messages.Bpmn2NewDiagramFileWizard_CreationPageDescription,
		...
		diagramRootElementSelectionPage
				.setTitle(Messages.Bpmn2NewDiagramFileWizard_RootSelectionPageTitle);
		diagramRootElementSelectionPage
				.setDescription(Messages.Bpmn2NewDiagramFileWizard_RootSelectionPageDescription);
	...
	public boolean performFinish() {
		...
		Bpmn2DiagramEditorUtil.setCharset(diagramFile);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				myEditingDomain,
				Messages.Bpmn2NewDiagramFileWizard_InitDiagramCommand,
				affectedFiles) {

			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				int diagramVID = Bpmn2VisualIDRegistry
	...
	private static class DiagramRootElementSelectionPage extends
		...
		protected String getSelectionTitle() {
			return Messages.Bpmn2NewDiagramFileWizard_RootSelectionPageSelectionTitle;
		}
