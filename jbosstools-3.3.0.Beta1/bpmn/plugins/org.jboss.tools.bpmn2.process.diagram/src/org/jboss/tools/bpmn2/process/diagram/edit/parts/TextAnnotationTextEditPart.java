 ...
 * @generated
 */
public class TextAnnotationTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = Bpmn2ParserProvider
					.getParser(
							...
							Bpmn2VisualIDRegistry
									.getType(org.jboss.tools.bpmn2.process.diagram.edit.parts.TextAnnotationTextEditPart.VISUAL_ID));
		}
		return parser;
	}
