 ...
 ******************************************************************************/ 
package org.jboss.tools.shale.ui.clay.editor.print;
...
public class PagesView extends Composite implements MouseListener, PaintListener {
	...
	Vector<IFigure> figures = new Vector<IFigure>();
...
//		Color red = new Color(pe.display, 0xff, 0x00, 0x00);
//		Color green = new Color(pe.display, 0x00, 0xff, 0x00);
		Color gray = pe.display.getSystemColor(SWT.COLOR_GRAY);
//		Color blue = new Color(pe.display, 0x00, 0x00, 0xff);
//		Color blackColor = new Color(null, 0x00, 0x00, 0x00);
//		Color whiteColor = new Color(null, 0xff, 0xff, 0xff);
//		Color orangeColor = new Color(null, 0xff, 0xea, 0x82);
		Color yellowColor = new Color(null, 0xff, 0xf6, 0xcb);
//		Color lightGrayColor = new Color(null, 0xf1, 0xf1, 0xf1);
//		Color darkGrayColor = new Color(null, 0xb3, 0xb3, 0xb3);
//		Color lightBlueColor = new Color(null, 0xcb, 0xeb, 0xff);
//		Color darkBlueColor = new Color(null, 0x82, 0xcf, 0xff);
//		Color selectedColor = new Color(null, 0xf0, 0xe8, 0xbf);
//		Color borderColor = new Color(null, 0x86, 0x7d, 0x51);
		...
		for (int i = 0; i < figures.size(); i++) {
			...
			if (f1 instanceof PolylineConnection) {
				...
				if (f1 instanceof ComponentFigure) {
///					ComponentFigure group = (ComponentFigure) f1;
					...
					if (f1 instanceof Label) {
						...
						Font ff = f1.getFont();
///						int dm = 
							FigureUtilities.getTextWidth(s, ff);
						FontData fd = ff.getFontData()[0];
///						int h = fd.getHeight();
///						int nh = (int) (h * viewScale);
