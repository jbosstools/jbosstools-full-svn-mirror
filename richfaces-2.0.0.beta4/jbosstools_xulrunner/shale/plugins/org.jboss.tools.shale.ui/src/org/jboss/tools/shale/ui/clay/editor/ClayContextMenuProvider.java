...
public class ClayContextMenuProvider extends org.eclipse.gef.ContextMenuProvider {
//	private ActionRegistry actionRegistry;
	private MouseEvent lastDownEvent = null;

	public ClayContextMenuProvider(EditPartViewer viewer, ActionRegistry registry) {
		super(viewer);
	...
	protected void update(boolean force, boolean recursive) {
		...
		if(object != null) {
			...
			if(lastDownEvent != null) {
				...
				((ClayDiagramEditPart)getViewer().getRootEditPart().getChildren().get(0)).getFigure().translateToRelative(point);
