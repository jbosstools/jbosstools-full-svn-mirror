 ...
 ******************************************************************************/ 
package org.jboss.tools.shale.ui;
...
public class ShaleUiPlugin extends AbstractUIPlugin {
	public static String PLUGIN_ID = "org.jboss.tools.shale.ui";
	static ShaleUiPlugin INSTANCE = null;

	public ShaleUiPlugin() {
		INSTANCE = this;
	}
	...
	public static ShaleUiPlugin getDefault() {
		return INSTANCE;
	}
