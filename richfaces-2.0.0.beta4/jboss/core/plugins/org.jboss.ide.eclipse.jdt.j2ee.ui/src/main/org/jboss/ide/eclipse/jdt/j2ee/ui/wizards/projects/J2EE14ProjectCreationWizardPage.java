...
public class J2EE14ProjectCreationWizardPage extends ProjectWizardPage
{
   ...
   {
      super(mainPage);
      this.setTitle(JDTJ2EEUIMessages.getString("J2EE14ProjectCreationWizardPage.title"));//$NON-NLS-1$
      this.setDescription(JDTJ2EEUIMessages.getString("J2EE14ProjectCreationWizardPage.description"));//$NON-NLS-1$
   }
      ...
      throws CoreException
   {
      ...
      entries = JavaProjectUtil.mergeClasspathEntry(entries, ClassPathContainerRepository.getInstance().getEntry(J2EE14ClasspathContainer.CLASSPATH_CONTAINER));
