...
public class JBoss30xTabGroup extends ServerTabGroup
{
   ...
   public void createTabs(ILaunchConfigurationDialog dialog, String mode)
   {
      ILaunchConfigurationTab[] tabs =
            ...
            LauncherUIMessages.getString("JBoss30xTabGroup.start.tab")), //$NON-NLS-1$
            new ServerLaunchArgumentsTab(
            ...
            LauncherUIMessages.getString("JBoss30xTabGroup.shutdown.tab")), //$NON-NLS-1$
            new LogFileTab(),
			new SourceLookupTab(),
   ...
   public void setDefaults(ILaunchConfigurationWorkingCopy configuration)
   {
      ServerLaunchUtil.setRelativeToHomedirClasspath(
            LaunchType.START,
            configuration,
            new String[]{IJBossConstants.RUN_JAR_RELATIVE_TO_JBOSS_HOME});

      ServerLaunchUtil.setRelativeToJDKClasspath(
            LaunchType.START,
            configuration,
            new String[]{IJBossConstants.TOOLS_JAR_RELATIVE_TO_JDK_HOME_3X});
      ...
      ServerLaunchUtil.setRelativeToHomedirClasspath(
            LaunchType.SHUTDOWN,
            configuration,
            new String[]{IJBossConstants.SHUTDOWN_JAR_RELATIVE_TO_JBOSS_HOME_3X});

      ServerLaunchUtil.setMainType(
            LaunchType.SHUTDOWN,
            configuration,
            IJBossConstants.JBOSS_SHUTDOWN_CLASS_3X);

      ServerLaunchUtil.setUserProgramArgs(
            LaunchType.SHUTDOWN,
            configuration,
            getShutdownProgramArgs());
