 ...
 * @version   $Revision$
 */
public class JSPResultCollector extends CompletionProposalCollector
{
   ...
   public JSPResultCollector(IJavaProject project) { super(project); }
   ...
   public void accept(CompletionProposal proposal) {
	   ...
	   {
		   char [] fieldName = proposal.getName();
		   if (this.filterName(fieldName))
		   {
			   return;
		   }
	   }
...
//      }
//
//	  CompletionProposal proposal = CompletionProposal.create(CompletionProposal.ANONYMOUS_CLASS_DECLARATION, completionStart);
//	  proposal.setRelevance(relevance);
//	  
//	  super.accept(createJavaCompletionProposal());
