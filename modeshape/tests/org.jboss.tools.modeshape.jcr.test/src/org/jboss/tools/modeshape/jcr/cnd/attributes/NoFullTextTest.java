 ...
 * 
 */
public class NoFullTextTest implements Constants {

    private NoFullText attribute;

    @Before
    public void beforeEach() {
        this.attribute = new NoFullText();
    }
    ...
    public void verifyCompactCndNotation() {
        ...
        assertEquals(NoFullText.NOTATION[NotationType.COMPACT_INDEX], this.attribute.toCndNotation(NotationType.COMPACT));
    }

    @Test
    public void verifyCompressedCndNotation() {
        this.attribute.set(AttributeState.Value.IS);
        assertEquals(NoFullText.NOTATION[NotationType.COMPRESSED_INDEX], this.attribute.toCndNotation(NotationType.COMPRESSED));
    }

    @Test
    public void verifyLongCndNotation() {
        this.attribute.set(AttributeState.Value.IS);
        assertEquals(NoFullText.NOTATION[NotationType.LONG_INDEX], this.attribute.toCndNotation(NotationType.LONG));
    }

    @Test
    public void verifyVariantCompactCndNotation() {
        this.attribute.set(AttributeState.Value.VARIANT);
        assertEquals(NO_FULL_TEXT_VARIANT_COMPACT_FORM, this.attribute.toCndNotation(NotationType.COMPACT));
    }

    @Test
    public void verifyVariantCompressedCndNotation() {
        this.attribute.set(AttributeState.Value.VARIANT);
        assertEquals(NO_FULL_TEXT_VARIANT_COMPRESSED_FORM, this.attribute.toCndNotation(NotationType.COMPRESSED));
    }

    @Test
    public void verifyVariantLongCndNotation() {
        this.attribute.set(AttributeState.Value.VARIANT);
        assertEquals(NO_FULL_TEXT_VARIANT_LONG_FORM, this.attribute.toCndNotation(NotationType.LONG));
    }
