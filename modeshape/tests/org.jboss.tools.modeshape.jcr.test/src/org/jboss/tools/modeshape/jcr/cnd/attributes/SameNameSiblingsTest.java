 ...
 * 
 */
public class SameNameSiblingsTest implements Constants {

    private SameNameSiblings attribute;

    @Before
    public void beforeEach() {
        this.attribute = new SameNameSiblings();
    }
    ...
    public void verifyCompactCndNotation() {
        ...
        assertEquals(SameNameSiblings.NOTATION[NotationType.COMPACT_INDEX], this.attribute.toCndNotation(NotationType.COMPACT));
    }

    @Test
    public void verifyCompressedCndNotation() {
        this.attribute.set(AttributeState.Value.IS);
        assertEquals(SameNameSiblings.NOTATION[NotationType.COMPRESSED_INDEX],
    ...
    public void verifyLongCndNotation() {
        this.attribute.set(AttributeState.Value.IS);
        assertEquals(SameNameSiblings.NOTATION[NotationType.LONG_INDEX], this.attribute.toCndNotation(NotationType.LONG));
    }

    @Test
    public void verifyVariantCompactCndNotation() {
        this.attribute.set(AttributeState.Value.VARIANT);
        assertEquals(SAME_NAME_SIBLINGS_VARIANT_COMPACT_FORM, this.attribute.toCndNotation(NotationType.COMPACT));
    }

    @Test
    public void verifyVariantCompressedCndNotation() {
        this.attribute.set(AttributeState.Value.VARIANT);
        assertEquals(SAME_NAME_SIBLINGS_VARIANT_COMPRESSED_FORM, this.attribute.toCndNotation(NotationType.COMPRESSED));
    }

    @Test
    public void verifyVariantLongCndNotation() {
        this.attribute.set(AttributeState.Value.VARIANT);
        assertEquals(SAME_NAME_SIBLINGS_VARIANT_LONG_FORM, this.attribute.toCndNotation(NotationType.LONG));
    }
