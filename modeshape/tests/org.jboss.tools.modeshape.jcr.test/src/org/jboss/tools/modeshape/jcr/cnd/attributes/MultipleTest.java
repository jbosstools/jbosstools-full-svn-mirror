 ...
 * 
 */
public class MultipleTest implements Constants {

    private Multiple attribute;

    @Before
    public void beforeEach() {
        this.attribute = new Multiple();
    }
    ...
    public void verifyCompactCndNotation() {
        ...
        assertEquals(Multiple.NOTATION[NotationType.COMPACT_INDEX], this.attribute.toCndNotation(NotationType.COMPACT));
    }

    @Test
    public void verifyCompressedCndNotation() {
        this.attribute.set(AttributeState.Value.IS);
        assertEquals(Multiple.NOTATION[NotationType.COMPRESSED_INDEX], this.attribute.toCndNotation(NotationType.COMPRESSED));
    }

    @Test
    public void verifyLongCndNotation() {
        this.attribute.set(AttributeState.Value.IS);
        assertEquals(Multiple.NOTATION[NotationType.LONG_INDEX], this.attribute.toCndNotation(NotationType.LONG));
    }

    @Test
    public void verifyVariantCompactCndNotation() {
        this.attribute.set(AttributeState.Value.VARIANT);
        assertEquals(MULTIPLE_VARIANT_COMPACT_FORM, this.attribute.toCndNotation(NotationType.COMPACT));
    }

    @Test
    public void verifyVariantCompressedCndNotation() {
        this.attribute.set(AttributeState.Value.VARIANT);
        assertEquals(MULTIPLE_VARIANT_COMPRESSED_FORM, this.attribute.toCndNotation(NotationType.COMPRESSED));
    }

    @Test
    public void verifyVariantLongCndNotation() {
        this.attribute.set(AttributeState.Value.VARIANT);
        assertEquals(MULTIPLE_VARIANT_LONG_FORM, this.attribute.toCndNotation(NotationType.LONG));
    }
