    ...
    private TagInfo createTagInfo(TreeNode elem, String jspVersion)
        ...
        if (teiClassName != null && !teiClassName.equals("")) {
            try {
                ...
                // MODIFIED : Classloading debugging
                Class TagExtraInfoClass1 = ctxt.getClassLoader().loadClass("javax.servlet.jsp.tagext.TagExtraInfo");
                ClassLoader TagExtraInfoClass1CL = TagExtraInfoClass1.getClassLoader();
                Class TagExtraInfoClass2 =  TagExtraInfo.class;
                ClassLoader TagExtraInfoClass2CL = TagExtraInfoClass2.getClassLoader();
