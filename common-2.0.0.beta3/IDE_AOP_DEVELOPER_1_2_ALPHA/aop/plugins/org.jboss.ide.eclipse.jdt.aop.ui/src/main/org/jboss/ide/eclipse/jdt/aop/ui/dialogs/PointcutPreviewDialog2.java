...
public class PointcutPreviewDialog2 extends Dialog
{
      ...
      public void addListeners()
      {
         add.addSelectionListener(new SelectionListener()
         {
            ...
            public void widgetSelected(SelectionEvent e)
            {
               ...
               {
                  collected.setText(collected.getText() + ", " + typeComposite.toString1());
               }
   ...
   public static class TypeComposite extends Composite implements PointcutComposite
   {
       ...
       */
      public TypeComposite(Composite parent, boolean enableBaseTypes, boolean enableVoid, String labelString,
            String expression)
      {
      ...
      public TypeComposite(Composite parent, boolean enableBaseTypes, boolean enableVoid, String labelString,
            boolean classOnly, String expression)
      {
         super(parent, SWT.NONE);
         c = this;
      ...
      public String toString1()
      {
         if (patternType.getItem(patternType.getSelectionIndex()).equals(PointcutPreviewAssistComposite.CLASS))
         {
            return pattern.getText();
         }
         if (patternType.getItem(patternType.getSelectionIndex()).equals(PointcutPreviewAssistComposite.ANNOTATION))
         {
            return "@" + pattern.getText();
         }
         if (patternType.getItem(patternType.getSelectionIndex()).equals(PointcutPreviewAssistComposite.INSTANCE_OF))
         {
            return "$instanceof{" + pattern.getText() + "}";
         }
         if (patternType.getItem(patternType.getSelectionIndex()).equals(PointcutPreviewAssistComposite.TYPEDEF))
         {
   ...
   public static class NameComposite extends Composite implements PointcutComposite
   {
      ...
      public NameComposite(Composite parent, boolean cons, String labelString, String expression)
      {
         ...
         AopUICompletionProcessor processor = new AopUICompletionProcessor(annotPattern);
         processor.setType(AopUICompletionProcessor.ANNOTATION);
         ...
         combo.addSelectionListener(new SelectionListener()
         {
            ...
            public void widgetSelected(SelectionEvent e)
            {
               if (combo.getItem(combo.getSelectionIndex()).equals(PointcutPreviewAssistComposite.NAME))
               {
      ...
      public Text getPattern()
      {
         if (combo1.getItem(combo1.getSelectionIndex()).equals(PointcutPreviewAssistComposite.NAME))
         {
            return namePattern;
         }
         else
      ...
      public String toString1()
      {
         if (combo1.getItem(combo1.getSelectionIndex()).equals(PointcutPreviewAssistComposite.ANNOTATION))
         {
   ...
   public static class MemberComposite extends Composite implements PointcutComposite
   {
      ...
      private String typeExpr, classNameExpr, paramsExpr, exceptionExpr, memberNameExpr, permissions, staticity;
      ...
      public MemberComposite(Composite parent, boolean isMethod, boolean isConstructor, String expression)
      {
         super(parent, SWT.NONE);
      ...
      private void createOtherLayoutItems()
      {
         if (!isConstructor)
         {
            if (isMethod)
            {
               type = new TypeComposite(this, true, true, "Return Type Pattern (use * for any type)", typeExpr);

            }
            else
            {
               type = new TypeComposite(this, true, true, "Member Type Pattern (use * for any type)", typeExpr);
            }
         }

         className = new TypeComposite(this, false, false, "Class Type Pattern (use * for any type)", classNameExpr);
      ...
      {
         String retVal = "";
         String permission = permissionCombo.getSelectionIndex() < 0 ? "" : permissionCombo.getItem(permissionCombo
               .getSelectionIndex());
         ...
         String staticS = staticCombo.getSelectionIndex() < 0 ? "" : staticCombo.getItem(staticCombo
               .getSelectionIndex());
         ...
         if (isMethod)
         {
            ...
            retVal += exceptions.toString1().equals("") ? "" : " throws " + exceptions.toString1();
         }
