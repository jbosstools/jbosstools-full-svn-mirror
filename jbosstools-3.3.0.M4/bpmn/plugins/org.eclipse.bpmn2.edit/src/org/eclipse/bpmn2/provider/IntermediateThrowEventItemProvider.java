...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn2.IntermediateThrowEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntermediateThrowEventItemProvider extends ThrowEventItemProvider implements
    ...
    /**
     * This returns IntermediateThrowEvent.png.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated not
     */
    ...
    public Object getImage(Object object) {
        try {
            return overlayImage(object,
                    getResourceLocator().getImage(getImagePath((IntermediateThrowEvent) object)));
        } catch (java.util.MissingResourceException ignore) {
        }
        try {
            return overlayImage(object,
                    getResourceLocator().getImage("full/obj16/IntermediateThrowEvent.png"));
        } catch (java.util.MissingResourceException e) {
            return overlayImage(object,
                    getResourceLocator().getImage("full/obj16/IntermediateThrowEvent.gif"));
        }
    }
    ...
    private boolean isMessageEvent(IntermediateThrowEvent intermediateThrowEvent) {
        ...
        List<EventDefinition> eventDefinitionRefs = intermediateThrowEvent.getEventDefinitionRefs();
    ...
    private String getImagePath(IntermediateThrowEvent intermediateThrowEvent) {
        if (isMessageEvent(intermediateThrowEvent)) {
            return "added/obj16/events_16px_intermediate_message_throw.png";
        } else {
            // this needs to be changed into a 'none' event
