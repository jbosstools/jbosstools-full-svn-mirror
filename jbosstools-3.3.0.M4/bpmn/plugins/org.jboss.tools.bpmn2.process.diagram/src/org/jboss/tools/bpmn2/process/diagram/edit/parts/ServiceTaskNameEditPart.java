 ...
 * @generated
 */
public class ServiceTaskNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = Bpmn2ParserProvider
					.getParser(
							...
							Bpmn2VisualIDRegistry
									.getType(org.jboss.tools.bpmn2.process.diagram.edit.parts.ServiceTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
