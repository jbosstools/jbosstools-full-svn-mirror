 ...
 * @generated
 */
public class BusinessRuleTaskCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public BusinessRuleTaskCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance()
				.init_BusinessRuleTask_2018(newElement);
