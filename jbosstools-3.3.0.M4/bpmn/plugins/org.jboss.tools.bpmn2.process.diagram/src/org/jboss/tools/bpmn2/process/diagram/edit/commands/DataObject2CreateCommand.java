 ...
 * @generated
 */
public class DataObject2CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public DataObject2CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance().init_DataObject_3014(newElement);
