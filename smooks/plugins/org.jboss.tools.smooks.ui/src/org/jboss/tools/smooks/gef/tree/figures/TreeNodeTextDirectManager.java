 ...
 * 
 */
public class TreeNodeTextDirectManager extends DirectEditManager {
	Font scaledFont;
	 ...
	 */
	public TreeNodeTextDirectManager(GraphicalEditPart source, Class<?> editorType, CellEditorLocator locator, Label label) {
