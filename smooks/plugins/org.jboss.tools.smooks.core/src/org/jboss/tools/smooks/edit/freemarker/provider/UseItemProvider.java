...
/**
 * This is the item provider adapter for a {@link freemarker.Use} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FreemarkerPackage.Literals.USE__INLINE);
			childrenFeatures.add(FreemarkerPackage.Literals.USE__BIND_TO);
			childrenFeatures.add(FreemarkerPackage.Literals.USE__OUTPUT_TO);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FreemarkerPackage.Literals.USE__INLINE,
				 FreemarkerFactory.eINSTANCE.createInline()));

		newChildDescriptors.add
			(createChildParameter
				(FreemarkerPackage.Literals.USE__BIND_TO,
				 FreemarkerFactory.eINSTANCE.createBindTo()));

		newChildDescriptors.add
			(createChildParameter
				(FreemarkerPackage.Literals.USE__OUTPUT_TO,
				 FreemarkerFactory.eINSTANCE.createOutputTo()));
	}
