...
public class Json12Switch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Json12Package.JSON12_DOCUMENT_ROOT: {
				Json12DocumentRoot json12DocumentRoot = (Json12DocumentRoot)theEObject;
				Object result = caseJson12DocumentRoot(json12DocumentRoot);
			...
			case Json12Package.JSON12_READER: {
				Json12Reader json12Reader = (Json12Reader)theEObject;
				Object result = caseJson12Reader(json12Reader);
				if (result == null) result = caseAbstractReader(json12Reader);
				if (result == null) result = caseAbstractResourceConfig(json12Reader);
				if (result == null) result = caseAbstractAnyType(json12Reader);
				if (result == null) result = caseAnyType(json12Reader);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
