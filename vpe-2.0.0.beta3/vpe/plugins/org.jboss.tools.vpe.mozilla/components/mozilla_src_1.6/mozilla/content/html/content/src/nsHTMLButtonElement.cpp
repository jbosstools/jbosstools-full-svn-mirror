                                    ...
                                    nsEventStatus* aEventStatus)
{
  ...
  if (NS_SUCCEEDED(ret) && 
	...
	/* It was commented by Sergey Vasilyev 2005-oct-31 */
	/**
		This comment was made for Drag'n'Drop element <BUTTON> in Visual Page Editor (VPE)
	*/
	/*
	case NS_MOUSE_LEFT_BUTTON_DOWN:
        ...
        break;
	*/
	/* End of comment was commented by Sergey Vasilyev 2005-oct-31 */
